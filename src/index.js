...
client.on("message", (message) => {
    ...
    if (author.bot || channel.id !== channelName || !content.startsWith(prefix)) return;
	
	// Separar a mensagem enviada pelo usuário 
	const args = content.toLowerCase().substring(prefix.length).split(" ");
    ...
    // const response = `comando ${commandName} solicitado`;
